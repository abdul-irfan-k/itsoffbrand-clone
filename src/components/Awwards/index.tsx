...
const Awwards = () => {
  return (
    ...
    <div className="gap-5 ml-auto flex flex-col w-[65%] ">
      <div className='flex items-center justify-between'>
        <span className='text-2xl'>awwards</span>
      ...
      <div className='flex items-center justify-between'>
        <span className='text-2xl'>fwa</span>
        <div className='gap-2 flex flex-col text-lg'>
            <span>fwa of the day<sup>03</sup></span>
        </div>
      </div>
      <div className='flex items-center justify-between'>
        <span className='text-2xl'>css design awward</span>
        <div className='gap-2 flex flex-col text-lg'>
            <span>site of the day<sup>08</sup></span>
        </div>
      </div>
      <div className='flex items-center justify-between'>
        <span className='text-2xl'>orpetron</span>
        <div className='gap-2 flex flex-col text-lg'>
            <span>site of the day<sup>08</sup></span>
